...
-- AddForeignKey
ALTER TABLE "customer_preference" ADD CONSTRAINT "customer_preference_reservation_id_fkey" FOREIGN KEY ("reservation_id") REFERENCES "reservation"("id") ON DELETE NO ACTION ON UPDATE NO ACTION;
